...
public class VerifyAddCustomer {
    public void verifyAdd() {
       ...
       driver.findElement(By.xpath("/html/body/div[2]/div/nav/ul/li[4]/a")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"email_address\"]")).sendKeys("xyz@abc.com");
       ...
       String expectedText="The Phone field must be at least 6 characters in length.";
